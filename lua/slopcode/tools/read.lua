...
return {
    ...
    description = 'Read the contents of a file from the filesystem. Use offset/limit for large files. Each line is prefixed with a hashline anchor (e.g. "5ab§line content") — use these anchors in edit calls to target specific lines.',
